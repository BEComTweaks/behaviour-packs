...
with open(f"{cdir()}/credits.md","r") as credits:
    ...
    html_end = f'</div><div class="download-container"><div class="file-download"><input type="text" id="fileNameInput" placeholder="Enter Pack name"></div><button class="download-selected-button" onclick="downloadSelectedTweaks()">Download Selected Tweaks</button><div id="selected-tweaks"><div class="tweak-list-pack">Select some packs and see them appear here!</div></div></div><script src="behaviour-pack-page.js"></script></body><footer style="auto" class="footer-container"><div class="credits-footer">{str(markdown(credit_unformatted))}<p><a href="https://github.com/BEComTweaks/behaviour-packs">GitHub</a></p></div></footer></html>'
