...
export const initializeSettings = (): void => {
  if (
    !getProperties<AntiCreeperGriefSettings>(
      world,
      AntiCreeperGriefSettingsDynamicProperties,
    ).initialized
  ) {
    setProperties(world, AntiCreeperGriefSettingsDynamicProperties, {
      initialized: true,
 ...
 */
export const getSettings = (): AntiCreeperGriefSettings =>
  getProperties<AntiCreeperGriefSettings>(
    world,
    AntiCreeperGriefSettingsDynamicProperties,
  );
...
export const setSettings = (
  antiCreeperGriefSettings: AntiCreeperGriefSettings,
): void => {
  setProperties(
    world,
    AntiCreeperGriefSettingsDynamicProperties,
